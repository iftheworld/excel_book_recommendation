...
Private Sub confirm_Click()
    ...
    If Me.OptionButton1.Value = True Then Range("G" & ActiveCell.Row) = 1
    If Me.OptionButton2.Value = True Then Range("G" & ActiveCell.Row) = 2
    '显示下一条
    Call next_row_Click
End Sub
...
Private Sub next_row_Click()
    ...
    Me.rec_number = Range("AD" & m_lngRow)
...
Private Sub UserForm_Initialize()
    ...
    Me.classCode = Range("T" & CStr(m_lngRow)): Me.readers = Range("U" & CStr(m_lngRow)): Me.rec_number = Range("AD" & CStr(m_lngRow)): Me.abstracts = Range("R" & CStr(m_lngRow))
